package fp.cake.ecom.order.infrastructure.secondary.entity;

import fp.cake.ecom.order.domain.order.aggregate.OrderedProduct;
import fp.cake.ecom.order.domain.order.aggregate.OrderedProductBuilder;
import fp.cake.ecom.order.domain.order.vo.OrderPrice;
import fp.cake.ecom.order.domain.order.vo.OrderQuantity;
import fp.cake.ecom.order.domain.order.vo.ProductPublicId;
import fp.cake.ecom.product.domain.vo.ProductName;
