package fp.cake.ecom.product.application;

import fp.cake.ecom.order.domain.order.aggregate.OrderProductQuantity;
import fp.cake.ecom.product.domain.aggregate.Category;
import fp.cake.ecom.product.domain.aggregate.FilterQuery;
import fp.cake.ecom.product.domain.aggregate.Product;
import fp.cake.ecom.product.domain.repository.CategoryRepository;
import fp.cake.ecom.product.domain.repository.ProductRepository;
import fp.cake.ecom.product.domain.service.CategoryCRUD;
import fp.cake.ecom.product.domain.service.ProductCRUD;
import fp.cake.ecom.product.domain.service.ProductShop;
import fp.cake.ecom.product.domain.service.ProductUpdater;
